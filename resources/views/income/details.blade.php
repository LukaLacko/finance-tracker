...
@section("title", "Details - " . $income->title)
            ...
            <div class="card shadow border-0 overflow-hidden">
                <div class="card-header bg-primary py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <span class="badge bg-light text-primary fs-6">{{ $income->category->name }}</span>
                    </div>
                </div>
                ...
                <div class="card-body p-4">
                    <div class="row mb-4 border-bottom pb-3">
                        <div class="col-sm-8">
                            ...
                            <h2 class="text-dark">{{ $income->title }}</h2>
                        </div>
                        <div class="col-sm-4 text-sm-end">
                            <label class="text-muted small text-uppercase fw-bold">Amount</label>
                            <h2 class="text-success fw-bold">${{ number_format($income->amount, 2) }}</h2>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div>
                                    ...
                                    <span class="fw-semibold">{{ $income->created_at->format('d.m.Y H:i') }}</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div>
                                    ...
                                    <span class="fw-semibold">{{ $income->updated_at->diffForHumans() }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="bg-light p-3 rounded-3 border-start border-primary border-4">
                            <p class="mb-0 text-secondary" style="white-space: pre-wrap;">{{ $income->description ?? 'No extra details provided.' }}</p>
                        </div>
                    </div>

                    <div class="mt-5">
                        <a href="{{ route('loggedin.income') }}" class="btn btn-outline-secondary px-4">
